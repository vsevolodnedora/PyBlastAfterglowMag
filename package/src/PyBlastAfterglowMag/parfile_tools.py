...
from .parfile_parameter_list import *
...
def create_parfile(working_dir : str, P : dict):
    ...
    lines = _create_parfile_part(lines=lines,part="main",
                         sep1="# -------------------------- main ---------------------------",
                         sep2="# --------------------------- END ---------------------------",
                         default=copy.deepcopy(default_parfile_main_part),
                         new=P)
    ...
    if ("grb" in P.keys()):
        lines = _create_parfile_part(
            ...
            sep1="# ---------------------- GRB afterglow ----------------------",
            sep2="# --------------------------- END ---------------------------",
            default=copy.deepcopy(default_parfile_grb_part),
            new=P
        )
    ...
    if ("magnetar" in P.keys()):
        _create_parfile_part(
            ...
            sep1="# ------------------------ Magnetar -------------------------",
            sep2="# --------------------------- END ---------------------------",
            default=copy.deepcopy(default_parfile_magnetar_part),
            new=P
        )
