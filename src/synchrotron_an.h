...
//        m_data_cspec.resize(cspec_vnames.size(), -1. );
//        m_cspec.resize( cspec_vnames.size() );
    ...
    void setPars(StrDbMap & pars, StrStrMap & opts){
        ...
        SynchrotronAnalytic::METHODS val_synch;
    ...
    void precompute(const double epime, const double Gamma, const double Gamma_shock,
                    const double t_e, const double n_prime) {
...
//        std::cout << m_data[i_abs] << "\n";
        ...
        m_data[QQ::i_int] = RadiationBase::computeIntensity(m_data[i_em], m_data[QQ::i_tau],
                                                            p_pars->method_tau);
    }
